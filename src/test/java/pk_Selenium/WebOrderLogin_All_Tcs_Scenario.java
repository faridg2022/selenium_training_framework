...
public class WebOrderLogin_All_Tcs_Scenario {

	ChromeDriver driver;
	// using dataProvider without extending the class
	@Test(priority = 1, dataProvider = "Weborder_Login_Scenario",dataProviderClass = TestData.class)
