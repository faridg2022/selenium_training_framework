...
public class Weborder_multiple_users extends TestData {
	ChromeDriver driver;
	@Test(priority = 1)
	...
	@Test(priority = 2,dataProvider="Customer_Name")
	public void CreateOrder(String name) throws InterruptedException {
		...
		String ActOutputname = driver.findElement(By.xpath("//td[text()='"+name+"']")).getText();
		String ExpOutputname = name;
